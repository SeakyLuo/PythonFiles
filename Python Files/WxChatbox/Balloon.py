    ...
    if plot1 == 0:
        ...
        if random.randint(0, 1):
            ...
            text += ['你一枪打在了气球上！', '还好没有人受伤！', '但老板被你吓出了心脏病！', '老板昏过去了！', '你很慌张，你不知道该怎么做', '但你觉得奖券更重要！', '所以你决定偷走了老板所有的奖券！', '你获得了5张奖券！', \
                    '你逃跑了！', '在一个夜深人静的晚上，你缩在被窝里']
            text.append('你对老板的事感到很内疚，但你仍然刮开了老板的奖券' if random.randint(0, 1) else '你对老板的事一点也不感到内疚，所以你刮开了老板的奖券')
            text += vouchers + ['游戏结束了，因为你老板的心很受伤', '老板再也不摆他那心爱的气球摊了']
        return Message(text)
    elif plot1 == 1:
