...
class Generator(Frame):
    def __init__(self, master):
        ...
        ## Modify Menu
        self.cmdMenu = Menu(self)
        self.cmdMenu.add_command(label = ADD, accelerator = shortcuts[ADD], command = self.add)
        ...
        self.cmdMenu.add_command(label = UPPER_TRIANGULAR, accelerator = shortcuts[UPPER_TRIANGULAR], command = lambda: self.triangularMatrix(UPPER))
        self.cmdMenu.add_separator()
        ...
        self.cmdMenu.add_cascade(label = SORT, menu = self.sortMenu)
        ...
        self.cmdMenu.add_cascade(label = REVERSE, menu = self.reverseMenu)
        ...
        for name, menu in zip(['Insert', 'Edit', 'Command', 'Generate', 'Result', 'Help'], [self.insertMenu, self.editMenu, self.cmdMenu, self.generateMenu, self.resultMenu, self.helpMenu]):
            menu['tearoff'] = False
